...
% Section~\ref{sect:windows} examines special issues in Windows.
% Section~\ref{sect:related} surveys related work.
% We describe our scheme and implementation in Section~\ref{sect:scheme}.
% Section~\ref{sect:cost} presents the benchmarks, and
% Section~\ref{sect:conclusion} concludes this section.
