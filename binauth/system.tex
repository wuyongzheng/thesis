\section{Binary Authentication and Software IDs}
\label{sect:scheme}
...
This is useful for dealing with vulnerability management problems \cite{vdb}.
...
\subsection{Binary Authentication System Architecture}
...
We choose to use a keyed hash, the HMAC algorithm \cite{rfc2104},
...
HMAC-MD5 \cite{rfc2104}, HMAC-SHA-1 
and HMAC-SHA-256 \cite{rfc4634} hash algorithms.\footnote{
Due to recent concerns which show weaknesses and attacks against MD5 \cite{md5-attack}, 
...
% As also discussed in \cite{bassov}, intercepting ({\tt NtCreateSec-\\tion()}
...
The security of binary authentication relies on the strength
