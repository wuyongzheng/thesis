...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=1.0\columnwidth]{dep-make-fail.png}
...
\begin{figure*}[htb]
\begin{center}
\includegraphics[width=1.0\textwidth]{dep-make-pp.png}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=1.0\columnwidth]{dep-make-matching.png}
