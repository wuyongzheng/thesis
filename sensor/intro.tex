\rule{\textwidth}{1pt}
{\em
This chapters shows external monitoring and how to use it to
detect and mitigate malware \cite{chang2010enhancing}.
...
The author of this thesis focuses on the monitoring framework
(Sec.~\ref{sec:sensor-framework}),
...
The detection of network related misuse is done by other other collaborators.
