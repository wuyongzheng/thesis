...
monitors external to the host, so that compromising the host would not
result the monitor being compromised, thus the monitored information can be trusted.
...
In addition, the monitored information of user interaction can be used to guide
