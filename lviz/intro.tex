...
\TODO{rewrite to make it connected}
...
% \TODO{reviewer 2:
% In section 1, you mention the VDP (what's that?) but I do not see a
% definition of that term before it's being used.  fixed.
% }

% \TODO{reviewer 3:
% What does the abbreviation VDP stands for? It is never introduced!  fixed.
% }
...
% \TODO{reviewer 3:
% The authors do not need to mention that the pictures are in color; that is
% standard for the visualization community.  fixed.
% }
