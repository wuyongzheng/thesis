\section{Comprehending Module Dependencies in Real Software}
\label{sec:apply}
...
The figures in this paper are all scalable and thus can be magnified
...
it easier to fit the graphs in the paper.
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\columnwidth]{depvis/boot-gdll.pdf}
...
\subsection{Comparing Web Browsers}

\begin{figure}
\centering
\includegraphics[width=1.0\columnwidth]{depvis/browsers-group-annot.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{depvis/gimp-vendor.pdf}
...
\subsection{Firefox: Plug-ins and a Surprise}
...
the {\tt svn} vendor group which is to do with
...
\subsection{Adobe Flash in Internet Explorer}
\label{sec:flash}

\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{depvis/ie-yt-diff.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{depvis/ie-yt-proj.pdf}
