...
The complex interactions make the software ecosystem very hard to understand.
...
bugs or features exploitable by malicious attackers.
Operating system monitoring is an effective way to understand these
interactions, especially when the source code is not available.
