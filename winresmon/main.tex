...
Appendix~\ref{sec:resmon-prior}. This example
...
native system calls as described in \cite{ddj-nthooking}.
Appendix~\ref{sec:resmon-syscall} lists the
...
\section{List of Intercepted System Calls}
\label{sec:resmon-syscall}
...
\section{Example of Log Priorities for Trace Compaction}
\label{sec:resmon-prior}
