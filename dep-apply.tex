...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\columnwidth]{dep-boot-gdll.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1.0\columnwidth]{dep-browsers-group-annot.pdf}
\caption{EXE dependency graph of three browsers: IE, Firefox, Opera}
\label{fig:browsers}
\end{figure}
\begin{figure*}[bth]
\includegraphics[width=1.0\textwidth]{dep-gimp-function-removed.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{dep-gimp-vendor.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1.0\columnwidth]{dep-firefox-vendor.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{dep-ie-yt-diff.pdf}
...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{dep-ie-yt-proj.pdf}
